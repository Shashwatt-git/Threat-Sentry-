...
st.set_page_config(page_title="Threat Sentry Assistant", page_icon=":speech_balloon:")

st.markdown("# <span style='color: #1DB954;'>Threat Sentry Assistant💬</span>", unsafe_allow_html=True)
