...
with st.sidebar:
    ...
    st.sidebar.markdown("Created by [Ashish Gidijala](https://www.linkedin.com/in/ashish-gidijala) [Shashwat Chandel](https://www.linkedin.com/in/shashwat-chandel-57943720a) ")


# ------------------ Main App UI ------------------ #

st.markdown("# <span style='color: #1DB954;'>Threat Sentry 👾</span>", unsafe_allow_html=True)
...
st.markdown("""          
            ...
            Threat Sentry solves this problem by using large language models to quickly generate attack scenarios based on a selection of a threat actor group's known techniques.
            """)
...
if st.session_state.get('chosen_model_provider') == "Azure OpenAI Service":
    st.markdown("""          
            ...
            4. Use `Threat Sentry Assistant` to refine / update the generated scenario, or ask more general questions about incident response testing.
            """)
    ...
    st.markdown("""          
            ...
            3. Use `Threat Sentry Assistant` to refine / update the generated scenario, or ask more general questions about incident response testing.
            """)
